...
export default function VideoMergerPage() {
  return (
    <ToolPageTemplate
      ...
      seo={{
        whatIs: `The Video Merger is a free online tool that works entirely in your browser. ToolNest's Video Merger lets you combine multiple video clips into one file. All processing happens locally — no uploads, no registration, no paid APIs.`,
        howTo: [
        ...
        { q: 'Does the Video Merger work on mobile?', a: 'Yes, the tool is fully responsive and works on any modern mobile browser.' },
    ...
    >
      <VideoTool config={videoToolConfigs['video-merger']} />
    </ToolPageTemplate>
  );
}
