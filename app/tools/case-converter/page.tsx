...
export const metadata: Metadata = generateToolMetadata('case-converter', 'Case Converter — Convert Text Case Online Free', 'Convert text to UPPERCASE, lowercase, Title Case, Sentence case, or tOGGLE cASE. Free, in your browser, no sign-up.');
