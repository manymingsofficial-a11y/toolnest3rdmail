...
export const metadata: Metadata = generateToolMetadata('css-minifier', 'CSS Minifier — Compress CSS Online Free', 'Minify CSS by removing comments, whitespace, and redundant code. Reduce file size for faster page loads — free, no sign-up.');
