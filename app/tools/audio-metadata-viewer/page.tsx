...
export const metadata = buildToolMetadata(
  ...
  'Audio Metadata Viewer',
  'View ID3 tags, bitrate and codec info.'
);
...
export default function AudioMetadataViewerPage() {
  return (
    <ToolPageTemplate
      ...
      seo={{
        whatIs: `The Audio Metadata Viewer is a free online tool that works entirely in your browser. ToolNest's Audio Metadata Viewer lets you view id3 tags, bitrate and codec info. All processing happens locally — no uploads, no registration, no paid APIs.`,
        howTo: [
        ...
        { q: 'Do I need to install any software?', a: 'No. The Audio Metadata Viewer runs entirely in your browser with no downloads or plugins required.' },
      ],
      }}
    >
      <AudioTool config={audioToolConfigs['audio-metadata-viewer']} />
    </ToolPageTemplate>
  );
}
