...
export const metadata: Metadata = generateToolMetadata('regex-tester', 'Regex Tester — Test Regular Expressions Online Free', 'Test regular expressions against your text in real time. See matches, highlights, and capture groups instantly — free, no sign-up.');
