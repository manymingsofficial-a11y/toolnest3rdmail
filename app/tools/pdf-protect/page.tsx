...
export default function PdfProtectPage() {
  return (
    <ToolPageTemplate
      ...
      seo={{
        whatIs: `The PDF Protect is a free online tool that works entirely in your browser. ToolNest's PDF Protect lets you add password protection to your pdf documents. All processing happens locally — no uploads, no registration, no watermarks.`,
        howTo: [
        ...
        faqs: [
        { q: 'Is the PDF Protect free to use?', a: 'Yes, it is completely free with no limits, no registration, and no watermarks.' },
        { q: 'Does the tool upload my data?', a: 'No. All processing happens locally in your browser. Your data is never sent to a server.' },
        { q: 'Does the PDF Protect work on mobile?', a: 'Yes, the tool is fully responsive and works on any modern mobile browser.' },
