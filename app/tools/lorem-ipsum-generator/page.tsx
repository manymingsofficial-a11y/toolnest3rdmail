...
export const metadata: Metadata = generateToolMetadata('lorem-ipsum-generator', 'Lorem Ipsum Generator — Placeholder Text Free', 'Generate lorem ipsum placeholder text as words, sentences, or paragraphs. Copy or download — free, in your browser.');
