...
export const metadata: Metadata = generateToolMetadata('keyword-density-checker', 'Keyword Density Checker — Analyze Word Frequency in Text', 'Check keyword density and word frequency in your content. Spot over-optimization, find top terms, and refine your SEO copy — free, no sign-up.');
