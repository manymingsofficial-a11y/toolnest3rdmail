...
export const metadata = buildToolMetadata(
  'video-cropper',
  'Video Cropper',
  'Crop video frames to any aspect ratio or dimension.'
);
...
export default function VideoCropperPage() {
  return (
    <ToolPageTemplate
      ...
      seo={{
        whatIs: `The Video Cropper is a free online tool that works entirely in your browser. ToolNest's Video Cropper lets you crop video frames to any aspect ratio or dimension. All processing happens locally — no uploads, no registration, no paid APIs.`,
        howTo: [
        ...
        { q: 'Does the Video Cropper work on mobile?', a: 'Yes, the tool is fully responsive and works on any modern mobile browser.' },
    ...
    >
      <VideoTool config={videoToolConfigs['video-cropper']} />
    </ToolPageTemplate>
  );
}
