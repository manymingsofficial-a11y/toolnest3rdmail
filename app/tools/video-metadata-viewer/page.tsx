...
export const metadata = buildToolMetadata(
  ...
  'Video Metadata Viewer',
  'Inspect codec, resolution, duration and more.'
);
...
export default function VideoMetadataViewerPage() {
  return (
    <ToolPageTemplate
      ...
      seo={{
        whatIs: `The Video Metadata Viewer is a free online tool that works entirely in your browser. ToolNest's Video Metadata Viewer lets you inspect codec, resolution, duration and more. All processing happens locally — no uploads, no registration, no paid APIs.`,
        howTo: [
        ...
        { q: 'Do I need to install any software?', a: 'No. The Video Metadata Viewer runs entirely in your browser with no downloads or plugins required.' },
      ],
      }}
    >
      <VideoTool config={videoToolConfigs['video-metadata-viewer']} />
    </ToolPageTemplate>
  );
}
