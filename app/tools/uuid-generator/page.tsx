...
export const metadata: Metadata = generateToolMetadata('uuid-generator', 'UUID Generator — Generate UUID v4 Online Free', 'Generate random UUID v4 identifiers in bulk. Copy individual UUIDs or download as TXT — free, in your browser, no sign-up.');
