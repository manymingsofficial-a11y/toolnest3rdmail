...
export default function VideoThumbnailGeneratorPage() {
  return (
    <ToolPageTemplate
      ...
      seo={{
        whatIs: `The Video Thumbnail Generator is a free online tool that works entirely in your browser. ToolNest's Video Thumbnail Generator lets you extract frames from videos as thumbnail images. All processing happens locally — no uploads, no registration, no paid APIs.`,
        howTo: [
        ...
        { q: 'Do I need to install any software?', a: 'No. The Video Thumbnail Generator runs entirely in your browser with no downloads or plugins required.' },
      ],
      }}
    >
      <VideoTool config={videoToolConfigs['video-thumbnail-generator']} />
    </ToolPageTemplate>
  );
}
