...
export const metadata: Metadata = generateToolMetadata('slug-generator', 'Slug Generator — Create SEO-Friendly URL Slugs Online', 'Convert titles into clean, SEO-friendly URL slugs. Lowercase, hyphenated, stop-word removal, and transliteration — free, no sign-up.');
